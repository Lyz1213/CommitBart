...
def main():
    ...
    if args.finetune_task == 'sp':
        ...
        data_pre = Data_Preprocessor(args.block_size, target_size, tokenizer, model_type = args.model_type, args = args)
    ...
    if args.saved_path is not None:
        ...
        logger.info("load the model params from {}".format(ckpt))
    if args.local_rank == 0:
